...
void ATMCharacter::OnSprintStarted() { bSprintHeld = true; }
void ATMCharacter::OnSprintEnded() { bSprintHeld = false; }
void ATMCharacter::OnSlidePressed() { bSlidePressed = true; }
...
void ATMCharacter::OnGrappleEvadePressed()
{
    ...
    {
        Direction = GetLastMovementInputVector().GetSafeNormal();
    }
    else
    {
...
{
    return bCanUseTemporalClap && !bIsTemporalActive &&
        TransfigurationCasting && TransfigurationCasting->GetActiveSigilCount() > 0;
}
