...
// ********** Begin Class UTransfigurationRegistry Function GetAllSpellIDs *************************
struct Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics
{
	struct TransfigurationRegistry_eventGetAllSpellIDs_Parms
	{
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TransfigurationRegistry_eventGetAllSpellIDs_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::NewProp_ReturnValue_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UTransfigurationRegistry, nullptr, "GetAllSpellIDs", Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::TransfigurationRegistry_eventGetAllSpellIDs_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::TransfigurationRegistry_eventGetAllSpellIDs_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UTransfigurationRegistry::execGetAllSpellIDs)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TArray<FName>*)Z_Param__Result=P_THIS->GetAllSpellIDs();
	P_NATIVE_END;
}
// ********** End Class UTransfigurationRegistry Function GetAllSpellIDs ***************************
...
// ********** Begin Class UTransfigurationRegistry Function HasSpell *******************************
struct Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics
{
	struct TransfigurationRegistry_eventHasSpell_Parms
	{
		FName SpellID;
		bool ReturnValue;
	};
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_SpellID = { "SpellID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TransfigurationRegistry_eventHasSpell_Parms, SpellID), METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((TransfigurationRegistry_eventHasSpell_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(TransfigurationRegistry_eventHasSpell_Parms), &Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_SpellID,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UTransfigurationRegistry, nullptr, "HasSpell", Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::TransfigurationRegistry_eventHasSpell_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::TransfigurationRegistry_eventHasSpell_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UTransfigurationRegistry_HasSpell()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UTransfigurationRegistry_HasSpell_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UTransfigurationRegistry::execHasSpell)
{
	P_GET_PROPERTY(FNameProperty,Z_Param_SpellID);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->HasSpell(Z_Param_SpellID);
	P_NATIVE_END;
}
// ********** End Class UTransfigurationRegistry Function HasSpell *********************************
...
struct Z_Construct_UClass_UTransfigurationRegistry_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTransfigurationRegistry_GetAllSpellIDs, "GetAllSpellIDs" }, // 3929685710
		{ &Z_Construct_UFunction_UTransfigurationRegistry_GetSpell, "GetSpell" }, // 1653558289
		{ &Z_Construct_UFunction_UTransfigurationRegistry_GetSpellsByElement, "GetSpellsByElement" }, // 151865226
		{ &Z_Construct_UFunction_UTransfigurationRegistry_HasSpell, "HasSpell" }, // 216963316
	};
...
struct Z_CompiledInDeferFile_FID_Users_Lynette_Desktop_Unreal_Projects_Transfigure_Source_Transfigure_Transfiguration_TransfigurationRegistry_h__Script_Transfigure_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTransfigurationRegistry, UTransfigurationRegistry::StaticClass, TEXT("UTransfigurationRegistry"), &Z_Registration_Info_UClass_UTransfigurationRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTransfigurationRegistry), 53974242U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Lynette_Desktop_Unreal_Projects_Transfigure_Source_Transfigure_Transfiguration_TransfigurationRegistry_h__Script_Transfigure_2874350634(TEXT("/Script/Transfigure"),
